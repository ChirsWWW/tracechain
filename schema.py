...
SITES = {
    "produce": {
        ...
        "sub": "生产登记系统",
        "icon": "factory",
        "accent": "#2c5578", "accent2": "#37699a", "accent_soft": "#eef3f8",
    ...
    "logistics": {
        ...
        "sub": "流通上报系统",
        "icon": "truck",
        "accent": "#1d6157", "accent2": "#25776b", "accent_soft": "#ecf4f2",
    ...
    "retail": {
        ...
        "sub": "销售核销系统",
        "icon": "store",
        "accent": "#7d5a22", "accent2": "#96702c", "accent_soft": "#f7f2e9",
    ...
    "consume": {
        ...
        "sub": "消费验真系统",
        "icon": "shield",
        "accent": "#4a4080", "accent2": "#5c51a0", "accent_soft": "#f0eff7",
    ...
    "core": {
        ...
        "sub": "管理控制台",
        "icon": "link",
        "accent": "#24282f", "accent2": "#39404a", "accent_soft": "#eef0f3",
...
STAGES = {
    "produce": {
        "key": "produce", "label": "生产端", "icon": "factory",
        "url": "/",
        "owner": "生产厂家 / 代工厂",
        "brief": "商品下线登记。本端录入的内容构成该码的商品身份，是后续各环节的作业前提。",
        "max": 1,
        "repeat_hint": "每码 1 次，登记后不可修改",
    },
    "logistics": {
        "key": "logistics", "label": "流通端", "icon": "truck",
        "url": "/",
        "owner": "物流公司 / 仓储 / 配送站",
        "brief": "出入库、转运、签收逐次上报。本端不限次数，为唯一可连续作业的环节。",
        "max": 0,
        "repeat_hint": "不限次数，可连续作业",
    },
    "retail": {
        "key": "retail", "label": "销售端", "icon": "store",
        "url": "/",
        "owner": "门店 / 经销商 / 电商客服",
        "brief": "商品售出时核销。核销后该码进入已售状态，作为退换货与窜货稽查的依据。",
        "max": 1,
        "repeat_hint": "每码 1 次",
    },
    "consume": {
        "key": "consume", "label": "消费端", "icon": "shield",
        "url": "/",
        "owner": "终端消费者",
...
FIELDS = {
    "produce": [
        ...
        {"k": "batch", "label": "生产批次", "type": "text",
         "ph": "选填，如：B20260917", "group": "商品身份"},
