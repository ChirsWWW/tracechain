...
if not IS_CORE and os.environ.get("TC_WARMUP") != "0":
...
# 实例真睡下后线程也随之停止，那种情况由作业站的探活 + 轮询唤醒兜底。
if IS_CORE and os.environ.get("TC_KEEPALIVE", "1") != "0":
